...
#
#
# Parâmetro PROCESSCPU + ID - coleta os 5 processos Top/Down com alto tempo de CPU.
#
#
# EX:    .\DiscoveryProcess.ps1 PROCESSCPU 1112
#
#
# Parâmetro PROCESSMEMORY + ID - coleta os 5 processos Top/Down com alto consumo de Memória.
#
#
# BACKLOG
#
...
$line = Get-Process |Sort-Object -Property WorkingSet64 | Select-Object -Last 5
$compara = 1
write-host "{"
write-host " `"data`":[`n"
...
{
Get-Process | Where-Object { $_.Id -eq $2 } | Select-Object WorkingSet64 |select-object -ExpandProperty WorkingSet64
}
